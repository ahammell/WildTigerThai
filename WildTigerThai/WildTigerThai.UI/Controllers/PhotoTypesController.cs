...
namespace WildTigerThai.UI.Controllers
{
    public class PhotoTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PhotoType_ID,Type,Active")] PhotoType photoType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PhotoType_ID,Type,Active")] PhotoType photoType)
        {
            if (ModelState.IsValid)
            {
